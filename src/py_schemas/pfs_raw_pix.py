...
v_dict_direto = [
    ...
    fields=[
        bigquery.SchemaField('branch', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('accountNumber', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('accountType', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('openingDate', 'STRING', 'NULLABLE')
        ]
    ),
    ...
    fields=[
        ...
        bigquery.SchemaField('tradeName', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('taxId', 'STRING', 'NULLABLE')
        ]
    ),
