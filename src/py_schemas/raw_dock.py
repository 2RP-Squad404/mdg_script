...
debit_account = [
    ...
    fields=[
        ...
        bigquery.SchemaField('produto_description', 'STRING', 'NULLABLE')
        ]
    ),
    ...
    fields=[
        ...
        bigquery.SchemaField('dt_capture', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('dt_publish', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('dt_sync', 'STRING', 'NULLABLE'),
        bigquery.SchemaField('dt_transaction', 'STRING', 'NULLABLE'),
